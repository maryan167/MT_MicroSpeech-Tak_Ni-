...
CY_IGNORE_FILES:=$(filter %.$(CY_TOOLCHAIN_SUFFIX_C),$(CY_IGNORE_DIRS))\
					...
					$(filter %.$(CY_TOOLCHAIN_SUFFIX_s),$(CY_IGNORE_DIRS))\
					$(filter %.$(CY_TOOLCHAIN_SUFFIX_CC),$(CY_IGNORE_DIRS))\
...
CY_SEARCH_ALL_FILES:=$(patsubst $(CY_SEARCH_APP_PATH)/%,$(CY_INTERNAL_APP_PATH)/%,\
                        ...
                        -o -type f -name "*.$(CY_TOOLCHAIN_SUFFIX_s)" -print \
                        -o -type f -name "*.$(CY_TOOLCHAIN_SUFFIX_CC)" -print \
...
CY_SEARCH_s_FILES:=$(filter %.$(CY_TOOLCHAIN_SUFFIX_s),$(CY_SEARCH_ALL_FILES))
CY_SEARCH_CC_FILES:=$(filter %.$(CY_TOOLCHAIN_SUFFIX_CC), $(CY_SEARCH_ALL_FILES))
...
#
CY_SEARCH_EMPTY_DIRS:=$(filter-out $(CY_SEARCH_C_FILES) $(CY_SEARCH_S_FILES) $(CY_SEARCH_s_FILES) $(CY_SEARCH_CC_FILES)\
						$(CY_SEARCH_CPP_FILES) $(CY_SEARCH_O_FILES) $(CY_SEARCH_A_FILES) $(CY_SEARCH_H_FILES)\
						$(CY_SEARCH_HPP_FILES) $(CY_SEARCH_RESOURCE_DIR),$(CY_SEARCH_ALL_FILES))
...
$(info -> Found $(words $(CY_SEARCH_s_FILES)) .$(CY_TOOLCHAIN_SUFFIX_s) file(s))
$(info -> Found $(words $(CY_SEARCH_CC_FILES)) .$(CY_TOOLCHAIN_SUFFIX_CC) file(s))
...
CY_SEARCH_PRUNED_s_FILES:=$(filter-out $(foreach d,$(CY_SEARCH_IGNORE_FILES),$(filter $(d)%,$(CY_SEARCH_s_FILES))),$(CY_SEARCH_s_FILES))
CY_SEARCH_PRUNED_CC_FILES:=$(filter-out $(foreach d,$(CY_SEARCH_IGNORE_FILES),$(filter $(d)%,$(CY_SEARCH_CC_FILES))),$(CY_SEARCH_CC_FILES))
...
CY_SEARCH_AVAILABLE_s_SOURCES:=$(call CY_MACRO_FILTER_FILES,s)
CY_SEARCH_AVAILABLE_CC_SOURCES:=$(call CY_MACRO_FILTER_FILES,CC)
...
CY_SEARCH_APP_SOURCE:=$(sort $(CY_SEARCH_AVAILABLE_S_SOURCES) $(CY_SEARCH_AVAILABLE_s_SOURCES)\
                $(CY_SEARCH_AVAILABLE_C_SOURCES) $(CY_SEARCH_AVAILABLE_CC_SOURCES) $(CY_SEARCH_AVAILABLE_CPP_SOURCES))
