...
else ifeq ($$($(2)_SUFFIX),.$(CY_TOOLCHAIN_SUFFIX_CC))
...
CY_BUILD_SRC_CPP_FILES=$(filter %.$(CY_TOOLCHAIN_SUFFIX_CPP) %.$(CY_TOOLCHAIN_SUFFIX_CC),$(CY_BUILD_SRC_STRIPPED))
...
CY_BUILD_GENSRC_CPP_FILES=$(filter %.$(CY_TOOLCHAIN_SUFFIX_CPP) %.$(CY_TOOLCHAIN_SUFFIX_CC),$(CY_RECIPE_GENERATED))
...
CY_BUILD_EXTSRC_CPP_FILES=$(filter %.$(CY_TOOLCHAIN_SUFFIX_CPP) %.$(CY_TOOLCHAIN_SUFFIX_CC),$(CY_BUILD_EXTSRC_RELATIVE_STRIPPED) $(CY_BUILD_EXTSRC_ABSOLUTE_STRIPPED))
...
CY_BUILD_SRC_CPP_OBJ_FILES=$(addprefix $(CY_CONFIG_DIR)/,\
$(filter %.$(CY_TOOLCHAIN_SUFFIX_O), $(CY_BUILD_SRC_CPP_FILES:%.$(CY_TOOLCHAIN_SUFFIX_CPP)=%.$(CY_TOOLCHAIN_SUFFIX_O))) $(filter %.$(CY_TOOLCHAIN_SUFFIX_O), $(CY_BUILD_SRC_CPP_FILES:%.$(CY_TOOLCHAIN_SUFFIX_CC)=%.$(CY_TOOLCHAIN_SUFFIX_O))))
...
CY_BUILD_GENSRC_CPP_OBJ_FILES=$(patsubst $(CY_BUILDTARGET_DIR)/%,$(CY_CONFIG_DIR)/%,\
$(filter %.$(CY_TOOLCHAIN_SUFFIX_O), $(CY_BUILD_GENSRC_CPP_FILES:%.$(CY_TOOLCHAIN_SUFFIX_CPP)=%.$(CY_TOOLCHAIN_SUFFIX_O))) $(filter %.$(CY_TOOLCHAIN_SUFFIX_O), $(CY_BUILD_GENSRC_CPP_FILES:%.$(CY_TOOLCHAIN_SUFFIX_CC)=%.$(CY_TOOLCHAIN_SUFFIX_O))))
...
CY_BUILD_EXTSRC_CPP_OBJ_FILES=$(addprefix $(CY_CONFIG_DIR)/user/,\
$(filter %.$(CY_TOOLCHAIN_SUFFIX_O), $(CY_BUILD_EXTSRC_CPP_FILES:%.$(CY_TOOLCHAIN_SUFFIX_CPP)=%.$(CY_TOOLCHAIN_SUFFIX_O))) $(filter %.$(CY_TOOLCHAIN_SUFFIX_O), $(CY_BUILD_EXTSRC_CPP_FILES:%.$(CY_TOOLCHAIN_SUFFIX_CC)=%.$(CY_TOOLCHAIN_SUFFIX_O))))
